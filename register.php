...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        $username_err = "Nomes de usuário podem somente conter letras, números e subtraços.";
    } else {
    ...
    if (empty(trim($_POST["password"]))) {
        ...
        $password_err = "Senhas devem ter pelo menos 6 caracteres.";
    } else {
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="reset" class="btn btn-secondary ml-2" value="Limpar Formulário">
            </div>
